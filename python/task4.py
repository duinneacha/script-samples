...
while True:
    ...
    theSentence = input()
    if theSentence:  ## NICE THAT YOU ARE CHECKING FOR NONE EMPTY INPUTS. BUT YOU SHOULD DO IT EXPLICITLY BY CALLING APPROPRIATE METHODS.
        break
